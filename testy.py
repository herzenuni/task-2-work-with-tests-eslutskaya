#Slutskaya Ekaterina, IVT, 2 kurs
#Код взят из задания 1
...
import doctest
#import unittest
#Импортируем необходимые библотеки, так как они не могут работать совместно, одна из них в импорте и коде закомментирована
